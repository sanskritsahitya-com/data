...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Lint JSON files using smart_json_dump formatting.")
    parser.add_argument("files", nargs="*", help="Specific JSON files to lint. If omitted, all files in data/ are linted.")
